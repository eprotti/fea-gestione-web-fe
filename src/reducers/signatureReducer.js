...
const signatureReducer = createSlice({
    ...
    initialState,
    reducers: {
        setAvailableSignatures: (state, action) => {
            state.availableSignatures = action.payload;
        },
...
export const { setAvailableSignatures, addSignature, moveSignature, resetSignatures, changePage, removeSignature } = signatureReducer.actions;
